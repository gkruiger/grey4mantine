...
const Data: Chapter[] = [{
  ...
  parts: [{
    ...
    content: [{
      ...
      id: 'start', 
      label: 'start', 
      changeChapter: 'chapter_i:_the_path',
      requires: []
    }, {
      requires: [],
      type: 'text', 
    ...
    content: [{
      type: 'text', 
      requires: [],
      text: `The passage takes me down a bit and ends in another cave. A much bigger one than the one I slept in. In the middle of the cave is a big structure. What?!`
    }, {
      type: 'action', 
      ...
      type: 'action', 
      id: 'enter_structure_fail', 
      label: 'Enter structure', 
      requires: ['examine_structure'],
      dont: ['fill_the_three_bars'],
